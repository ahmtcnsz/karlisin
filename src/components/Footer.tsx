      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-12 pt-8 border-t border-white/5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center text-left">
            <div>
              <h5 className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-3">Finansal Teknoloji Çözümleri</h5>
              <p className="text-[10px] text-slate-500 font-medium leading-relaxed max-w-2xl">
                Karlısın, yatırımcıların en çok ihtiyaç duyduğu <strong>temettü dağıtımı</strong>, <strong>temettü dağıtan hisseler</strong> ve <strong>2026 maaş hesaplama</strong> gibi kritik finansal metrikleri tek bir platformda toplar. 
                Unified Data Engine teknolojimiz ile BIST ve global borsalardaki <strong>temettü veren şirketler</strong> için 12 aylık hedef fiyat tahminleri, pazar kâr analizi ve borsa takibini en hassas verilerle sunuyoruz.
              </p>
            </div>
            <div className="flex flex-wrap gap-2 md:justify-end">
              {['Temettü Takvimi', 'Maaş Hesapla', 'Borsa Analizi', 'Pazar Kar Analizi', 'Temettü Veren Şirketler'].map(tag => (
